...
namespace ProxyMaid
{
    class ProxySourceScraper
    {
        ...
        private List<string> getListFromFile(string filePath)
        {
            List<string> list = new List<string>();
            string result = "";
        ...
        public void DoWork()
        {
            ...
            else
            {
                ...
                List<string> proxysources = getListFromFile(Properties.Settings.Default.ProxySource);
                ...
                banned = getListFromFile(Properties.Settings.Default.ProxyBanned);
            }
